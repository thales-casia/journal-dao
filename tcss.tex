...
\begin{figure}[h!]
  ...
  \caption{Distribute Token and Finance by DAO When Downloading}
...
By combining the principles of DAO with academic journal operations, this framework paves the way for a decentralized and community-driven approach to scholarly publishing. It empowers participants, promotes collaboration, and ensures the fair distribution of resources, ultimately leading to a more inclusive and sustainable academic publishing ecosystem.
