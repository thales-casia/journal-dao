...
This chapter introduces a web3-based Journal DAO system built on the foundation of blockchain technology. Leveraging NFTs, the system incorporates a set of incentive mechanisms, enabling the journal system to achieve perfect autonomy.
% 本文在区块链的基础上，创建一个基于web3的journal DAO系统。系统基于NFT给予了一套激励机制，让杂志系统完美自治。
