...
% 在去中心化科学框架中，核心参与者跟传统web2.0杂志没有太多区别，有文章的作者，一作、二作……通讯作者；有审稿人，Editors in Chief(EIC)、Senior Editor(SE)、Associate Editor(AE)；有读者，读者可能下载论文，也可能成为一个新的作者引用下载的论文；还有代表杂志的出版商。作者投稿，EIC分配审稿人，退稿，以及最终发布，从流程上几乎没有区别。读者下载论文，也跟web2。0杂志没有区别，但是本框架下，要求了引用论文必须下载，以保证DAO框架的正常运行。
